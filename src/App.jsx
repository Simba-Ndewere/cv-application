...
function App() {
  ...
  const [workExperience, setWorkExperience] = useState([{
    title: 'Senior Software Engineer', company: 'JP Morgan', id: crypto.randomUUID(), location: 'London', from: '2025 July', to: 'present', tasks: `
• Lead the design, development, and deployment of high-performance, low-latency applications used across trading, payments, or risk platforms.
